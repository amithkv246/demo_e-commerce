...

      {
        ...
        !showDetails ?
          ...
          (isMobile ?
            null
            :
            <Card style={{ width: '16rem', minHeight: "500px", boxShadow: "0px 0px 5px 3px #ddd" }}>
          ...
          (isMobile ?
            null
            :
            <Card style={{ maxWidth: '65rem', minHeight: "300px", boxShadow: "0px 0px 5px 3px #ddd" }}>
              ...
              <Card.Link href="#">Another Link</Card.Link> */}
                    <div>
                      ...
                      }
                      {
                        ...
                        // <ButtonCom value='Remove from Cart' bs='btn-outline-primary' onClick={() => { handleRemoveCartDetails ? handleRemoveCartDetails(item) : null }} />
                        <p className='fs-5 fw-bold text-primary bg-info-subtle' role='button' onClick={() => { handleRemoveCartDetails ? handleRemoveCartDetails(item) : null }} style={{ marginBottom: 0, padding: "0.5rem 5rem 0.5rem 5rem" }} >Remove from cart</p>
